...
```
npm create cloudflare@latest -- --template=cloudflare/templates/wispy-scene-5c02
```

A live public deployment of this template is available at [https://wispy-scene-5c02.templates.workers.dev](https://wispy-scene-5c02.templates.workers.dev)
